export const rentHouses = [
  {
    ...
    name: "Delhi",
    address: "DHA 9 City, India, India",
    price: 130000,
    details: [
      "4 Bedrooms",
    ...
    description:
      "DHA 9 Carpet Scheme A block 10 Marla New brand Carpets available for sale Good location Carpet near by hospital and market and masjid and LGS school and other facilities",
  },
  {
    id: 2,
    type: "featured",
    ...
    name: "Dubai",
    address: "Bahria Town, India, India",
    price: 100000,
    details: [
      "4 Bedrooms",
      "1 big launge",
    ...
    description:
      "Bahria Town 20 Marla New brand Carpet available for sale Good location Carpet near by hospital and market and masjid and school, park and other facilities in fully future developed society",
  },
  {
    id: 3,
    type: "popular",
    ...
    name: "Bhadohi",
    address: "Gulistan-e-Johar, Bhadohi, India",
    price: 50000,
    details: [
    ...
    description:
      "Carpet in installment (View phone number) Sqfeet VIP location near to park and masjid Gulistan-e-Johar karachi. You can find a Carpet on the lower or upper levels, as suiting to your requirement. Buying property is a one-time life decision and we can help you with it. 950 Square Feet sized residential or commercial property is best for investment purposes. All your queries concerned with this property are welcome, so please contact us.",
  },
  {
    id: 4,
    type: "popular",
    ...
    name: "America",
    address: "Blue Area, F-3, America, America",
    price: 135000,
    details: [
      "Location: Isra Tower",
      "2 Bedrooms",
  ...
  },
  {
    ...
    name: "Bhadohi",
    address: "Saadi Town, Bhadhoi, U.P.",
    price: 95000,
    details: [
  ...
  },
  {
    ...
    name: "Dubai",
    address: "Bahria Town, Dubai, Dubai",
    price: 120000,
    details: [
