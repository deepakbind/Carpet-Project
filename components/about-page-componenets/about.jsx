        ...
        >
          ...
          <div className="flex gap-12 max-sm:text-center text-white">
            <div className="flex max-md:items-center flex-col gap-4">
              ...
              <p className="text-lg">Premium Carpet</p>
            </div>
            <div className="flex max-md:items-center flex-col gap-4">
        ...
        >
          ...
          >
            ...
            <p className="text-xl mt-5">
              We are Carpet agency that has been established since 1995
        ...
        >
          ...
          >
            <h1 className="text-5xl ">
              ...
              <span className="text-red-500"> Carpet spectrum</span>
            </h1>
      ...
      <div className="bg-white">
        ...
        >
          ...
          >
            ...
            >
              We use Carpet to show our appreciation of the world.
            </motion.h1>
            <motion.p
              variants={animationVariants.fadeLeft}
              className="text-2xl"
            ...
            >
              <div className="flex flex-col max-lg:justify-center max-lg:items-center">
                ...
                <p className="text-xl">
                  Years of seccessful experience in  Carpet
                </p>
              </div>
              <div className="flex flex-col max-lg:justify-center max-lg:items-center">
                <h2 className="title-font text-red-500 text-5xl max-md:text-4xl font-semibold">
